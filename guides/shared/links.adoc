...
:author: OpenPEPPOL AISBL and Peppol Logistics Incubation Project 
:version: 1.0.0
:ord_version: 1.0.0
//PEPPOL
...
:ubl25: http://docs.oasis-open.org/ubl/UBL-2.5.html[UBL 2.5]
:ubl-waybill: http://docs.oasis-open.org/ubl/os-UBL-2.5/xsd/maindoc/UBL-Waybill-2.5.xsd[UBL Waybill 2.5]
:ubl-receipt-advice: http://docs.oasis-open.org/ubl/os-UBL-2.5/xsd/maindoc/UBL-ReceiptAdvice-2.5.xsd[UBL Receipt Advice 2.5]
:ubl-transport-execution-plan: http://docs.oasis-open.org/ubl/os-UBL-2.5/xsd/maindoc/UBL-TransportExecutionPlan-2.5.xsd[UBL Transport Execution Plan 2.5]
:ubl-transport-execution-plan-request: http://docs.oasis-open.org/ubl/os-UBL-2.5/xsd/maindoc/UBL-TransportExecutionPlanRequest-2.5.xsd[UBL Transport Execution Plan Request 2.5]
:ubl-transportation-status: http://docs.oasis-open.org/ubl/os-UBL-2.5/xsd/maindoc/UBL-TransportationStatus-2.5.xsd[UBL Transportation Status 2.5]
:ubl-transportation-status-request: http://docs.oasis-open.org/ubl/os-UBL-2.5/xsd/maindoc/UBL-TransportationStatusRequest-2.5.xsd[UBL Transportation Status Request 2.5]
:ubl-manifest: http://docs.oasis-open.org/ubl/os-UBL-2.5/xsd/maindoc/UBL-Manifest-2.5.xsd[UBL Manifest 2.5]
...
:ubl-appl-resp: http://docs.oasis-open.org/ubl/os-UBL-2.5/xsd/maindoc/UBL-ApplicationResponse-2.5.xsd[UBL Application Response 2.5]
:ubl-despatch-advice: http://docs.oasis-open.org/ubl/os-UBL-2.5/xsd/maindoc/UBL-DespatchAdvice-2.5.xsd[UBL Despatch Advice 2.5]
:ubl-weight-statement: http://docs.oasis-open.org/ubl/os-UBL-2.5/xsd/maindoc/UBL-WeightStatement-2.5.xsd[UBL Weight Statement 2.5]
